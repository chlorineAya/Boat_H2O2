...
//	private MyAdapter myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Path = tv+"/mods";
		string = Path + "/";
		listview4=(ListView)findViewById(R.id.runtimelistview4);
		 pd = new ProgressDialog(ModsActivity.this);
        ...
        if (files == null) {
			...
			list.add(map);
			SimpleAdapter sa = new SimpleAdapter(ModsActivity.this, list,
												 R.layout.list_m, new String[] { "img", "text" },
												 new int[] { R.id.listImageView1, R.id.listTextView1 });
			listview4.setAdapter(sa);
		}
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
		Map<String, Object> map;
		Arrays.sort(files);
		...
		listview4.setOnItemLongClickListener(new OnItemLongClickListener(){
				...
				{
					Object Texts=listview4.getItemAtPosition(p3);
					Map entry = (Map)Texts;
					final String  Text= (String) entry.get("text");
					String bo=Text+"/";
						String go=string+bo;
						String dui="/sdcard/";
					 AlertDialog alertDialog1 = new AlertDialog.Builder(listview4.getContext())
	...
	public void showDirectory(View view) {
		AlertDialog alertDialog2 = new AlertDialog.Builder(listview4.getContext())
