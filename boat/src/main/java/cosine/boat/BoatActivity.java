...
public class BoatActivity extends Activity implements View.OnClickListener, View.OnTouchListener, TextWatcher, TextView.OnEditorActionListener, TextureView.SurfaceTextureListener, SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		*/
        ...
        fwc = (LinearLayout) base.findViewById(R.id.fwc);
        ...
        //controlJump.getBackground().setAlpha(128);
...
//		control0 = this.findButton(R.id.control_0);
        ...
        if (jl.equals("Space")) {
            bu5.setBackground(getResources().getDrawable(R.drawable.be_j));
        } else {
            bu5.setBackground(getResources().getDrawable(R.drawable.be_s));
        }
        ...
        BoatActivity.this.bu1.getBackground().setAlpha(0);
        BoatActivity.this.bu2.getBackground().setAlpha(0);
        BoatActivity.this.bu3.getBackground().setAlpha(0);
        BoatActivity.this.bu4.getBackground().setAlpha(0);
        BoatActivity.this.bu5.getBackground().setAlpha(0);
        BoatActivity.this.bu6.getBackground().setAlpha(0);
        BoatActivity.this.bu7.getBackground().setAlpha(0);
        BoatActivity.this.bu8.getBackground().setAlpha(0);
                ...
                if (jl.equals("None")) {
                    if (p2.getAction() == MotionEvent.ACTION_DOWN) {
                        ...
                        if (ddy < wh / 3 && ddx < ww / 3) {
                            ...
                            BoatActivity.this.bu2.getBackground().setAlpha(128);
                            bu4.getBackground().setAlpha(128);
                            bu5.getBackground().setAlpha(128);
                            bu6.getBackground().setAlpha(128);
                            bu8.getBackground().setAlpha(128);

                            bu1.getBackground().setAlpha(195);
                            bu3.getBackground().setAlpha(0);
                            bu7.getBackground().setAlpha(0);
                            ...
                            BoatInput.setKey(BoatKeycodes.BOAT_KEYBOARD_s, 0, false);
                            BoatInput.setKey(BoatKeycodes.BOAT_KEYBOARD_d, 0, false);
                            bu2.getBackground().setAlpha(195);
                            bu4.getBackground().setAlpha(128);
                            bu5.getBackground().setAlpha(128);
                            bu6.getBackground().setAlpha(128);
                            bu8.getBackground().setAlpha(128);

                            bu1.getBackground().setAlpha(128);
                            bu3.getBackground().setAlpha(128);
                            bu7.getBackground().setAlpha(0);
                            bu9.getBackground().setAlpha(0);
                            ...
                            bu3.getBackground().setAlpha(195);
                            bu7.getBackground().setAlpha(0);
                            bu9.getBackground().setAlpha(0);
                            ...
                            BoatInput.setKey(BoatKeycodes.BOAT_KEYBOARD_d, 0, false);
                            bu2.getBackground().setAlpha(128);
                            bu4.getBackground().setAlpha(195);
                            bu5.getBackground().setAlpha(128);
                            bu6.getBackground().setAlpha(128);
                            bu8.getBackground().setAlpha(128);
                            ...
                            bu1.getBackground().setAlpha(128);
                            bu3.getBackground().setAlpha(0);
                            bu7.getBackground().setAlpha(128);
                            bu9.getBackground().setAlpha(0);
                            ...
                            bu2.getBackground().setAlpha(128);
                            bu4.getBackground().setAlpha(128);
                            bu5.getBackground().setAlpha(195);
                            bu6.getBackground().setAlpha(128);
                            bu8.getBackground().setAlpha(128);
                            ...
                            bu4.getBackground().setAlpha(128);
                            bu5.getBackground().setAlpha(128);
                            bu6.getBackground().setAlpha(195);
                            bu8.getBackground().setAlpha(128);

                            bu1.getBackground().setAlpha(0);
                            bu3.getBackground().setAlpha(128);
                            bu7.getBackground().setAlpha(0);
                            bu9.getBackground().setAlpha(128);
                            ...
                            bu1.getBackground().setAlpha(0);
                            bu3.getBackground().setAlpha(0);
                            bu7.getBackground().setAlpha(195);
                            bu9.getBackground().setAlpha(0);
                            ...
                            bu5.getBackground().setAlpha(128);
                            bu6.getBackground().setAlpha(128);
                            bu8.getBackground().setAlpha(195);
                            ...
                            bu3.getBackground().setAlpha(0);
                            bu7.getBackground().setAlpha(0);
                            bu9.getBackground().setAlpha(195);
                        }
    ...
    private void overlayshow() {
        ...
        this.fc.setVisibility(View.VISIBLE);
        ...
        this.touchMode.setVisibility(View.VISIBLE);
    ...
    private void overlayhide() {
        ...
        this.fc.setVisibility(View.INVISIBLE);
        this.controlInv.setVisibility(View.INVISIBLE);
        ...
        this.touchMode.setVisibility(View.INVISIBLE);
        this.bu2.setVisibility(View.INVISIBLE);
        this.bu4.setVisibility(View.INVISIBLE);
        this.bu5.setVisibility(View.INVISIBLE);
        this.bu6.setVisibility(View.INVISIBLE);
        this.bu8.setVisibility(View.INVISIBLE);
        this.button.setVisibility(View.INVISIBLE);
    ...
    public boolean onTouch(View p1, MotionEvent p2) {
        ...
        if (p1 == controlJump) {
            ...
            if (p2.getActionMasked() == MotionEvent.ACTION_DOWN) {
                BoatInput.setKey(BoatKeycodes.BOAT_KEYBOARD_space, 0, true);
                //controlJump.getBackground().setAlpha(195);
            } else if (p2.getActionMasked() == MotionEvent.ACTION_UP) {
                BoatInput.setKey(BoatKeycodes.BOAT_KEYBOARD_space, 0, false);
                //controlJump.getBackground().setAlpha(128);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case BoatInput.CursorDisabled:
                    ...
                    BoatActivity.this.button.setAlpha(1);
                    BoatActivity.this.bu1.getBackground().setAlpha(0);
                    BoatActivity.this.bu2.getBackground().setAlpha(128);
                    BoatActivity.this.bu3.getBackground().setAlpha(0);
                    BoatActivity.this.bu4.getBackground().setAlpha(128);
                    BoatActivity.this.bu5.getBackground().setAlpha(128);
                    BoatActivity.this.bu6.getBackground().setAlpha(128);
                    BoatActivity.this.bu7.getBackground().setAlpha(0);
                    BoatActivity.this.bu8.getBackground().setAlpha(128);
                    BoatActivity.this.bu9.getBackground().setAlpha(0);
                    ...
                    BoatActivity.this.fc.setAlpha(1);
                    break;
                ...
                case BoatInput.CursorEnabled:
                    ...
                    BoatActivity.this.button.setAlpha(0);
                    BoatActivity.this.bu1.getBackground().setAlpha(0);
                    BoatActivity.this.bu2.getBackground().setAlpha(0);
                    BoatActivity.this.bu3.getBackground().setAlpha(0);
                    BoatActivity.this.bu4.getBackground().setAlpha(0);
                    ...
                    BoatActivity.this.fc.setAlpha(0);
